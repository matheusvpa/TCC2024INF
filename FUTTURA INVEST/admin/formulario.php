<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $result = mysqli_query($conex, "INSERT INTO administradores(nome,email,telefone,sexo,data_nasc,cidade,estado,endereco,senha) 
...
<head>
    ...
    <title>Adicionar usuário - FUTTURA INVEST</title>
    <style>
        body{
