...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(to right, #052AA6 80%, #ffffff 100%);">
        <div class="container-fluid">
            <img src="../img/LogotipoFuttura.png" id="logotipo">
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
        </div>
        <div class="d-flex">
            <a href="signout_adm.php" class="btn btn-danger me-5">Sair</a>
        </div>
    </nav>
